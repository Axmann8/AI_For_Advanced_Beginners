...
| **Agent loop** | That think/act/observe cycle. See [Ch. 1](01-the-mental-model.md). |
...
| **MCP (Model Context Protocol)** | The open standard for connecting AI apps to tools and data. See [Ch. 2](02-mcp-explained.md). |
...
| **Prompt injection** | Malicious instructions hidden in content the AI reads. See [Ch. 12](12-safety-costs-and-gotchas.md). |

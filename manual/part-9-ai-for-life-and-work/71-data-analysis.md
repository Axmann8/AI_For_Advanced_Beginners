...
Connect a database MCP server ([Ch. 5](../part-2-mcp-and-connectors/09-mcp-server-catalog.md)) with a **read-only** user:
...
| **Vibe-coded web app** | Medium | A custom dashboard with Supabase data ([Ch. 19](../part-5-building-with-ai/34-vibe-coding-your-first-app.md)) |

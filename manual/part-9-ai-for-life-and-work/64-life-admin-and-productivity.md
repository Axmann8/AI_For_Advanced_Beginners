# 64 · Life Admin & Personal Productivity 🏡✅
...
|---|---|---|
| 📬 **Email & inbox** | Triage, summaries, reply drafts | *"Summarize these 20 emails: action needed, FYI, junk."* ([Email & Calendar](../part-4-ai-in-your-apps/26-email-and-calendar.md)) |
...
| 🏠 **Home** | Repairs, manuals, maintenance ([Home, Cooking & DIY](69-home-cooking-and-diy.md)) | *"[photo] What is this part, and how do I fix the leak?"* |
| 💸 **Money** | Budgets, subscriptions ([Money & Personal Finance](65-money-and-personal-finance.md)) | *"Find every subscription in this bank export."* |
| ✈️ **Travel** | Itineraries and packing ([Travel & Adventures](68-travel-and-adventures.md)) | *"Packing list for 5 days in Iceland in October."* |
| 🎁 **Relationships** | Gift ideas, cards, remembering details | *"Birthday message for my aunt who loves gardening and puns."* |
| 🩺 **Health admin** | Appointment prep ([Health](66-health-fitness-and-wellbeing.md)) | *"5 questions to ask my doctor about [topic]."* |
| 🏫 **School & family** | Decode school emails, plan logistics ([Parents](67-parents-teachers-and-students.md)) | *"Pull every date and thing-to-bring from this newsletter."* |
...
([Claude Code Power-Ups](../part-5-building-with-ai/32-claude-code-power-ups.md#-skills-packaged-expertise)).
...
```mermaid
flowchart LR
    P[📸 Photo of a letter] --> A[🤖 AI extracts<br/>deadline · action · amount]
    A --> T[✅ Task with due date]
    A --> S[📝 Plain-English summary]
```

Do it by hand in a chat, or automate it: phone shortcut → n8n → vision model → task app ([Phone & Desktop Automation](../part-3-automation/19-phone-and-desktop-automation.md)).
...
(Redact account numbers first. More in [Money & Personal Finance](65-money-and-personal-finance.md).)
...
More in [Accessibility & AI](70-accessibility-and-ai.md).
...
| **Consider local AI** for very private stuff | [Local & Open Models](../part-7-local-ai/47-local-and-open-models.md) |
...
<details class="quiz">
<summary>❓ 1. A confusing tax letter arrives. What three things should you ask AI?</summary>
...
<details class="quiz">
<summary>❓ 2. What should you do before uploading a bank statement?</summary>
...
<details class="quiz">
<summary>❓ 3. What's the "overwhelm reset"?</summary>
...
**Next:** [65 · Money & Personal Finance with AI →](65-money-and-personal-finance.md)

# 32 · AI for Research & Learning 🔬🎓

AI is the best tutor and research assistant most of us have ever had access to. It's patient, available
24/7, and it can explain anything at any level. Used well, it makes you **learn faster and think better**. Used
lazily, it just makes you *feel* like you learned. This chapter is about the first one.

---

## Part A: Research like a pro 🔎

### The research tool lineup
| Tool | Best for |
|---|---|
| **Deep research modes** (Claude Research, ChatGPT/Gemini Deep Research, Perplexity) | Multi-source reports with citations in minutes |
| **Perplexity** | Fast cited answers, and follow-up exploration |
| **NotebookLM** | Deep understanding of *your* chosen sources |
| **Elicit, Consensus, Semantic Scholar, scite** | Academic papers: finding, summarizing, checking claims |
| **MCP search servers** (Exa, Brave, Tavily) + your assistant | Custom research agents ([Ch. 8](../part-2-mcp-and-connectors/08-mcp-recipe-book.md)) |
...
- *"Steelman both sides of [debate], then tell me which evidence is strongest and why."*
- *"What would an expert in [field] say is the most common misconception about this?"*
- *"Rate each source's credibility and explain your reasoning."*
- *"What's the single study everyone cites on this? Summarize its methods and limitations."*
- *"What changed in this field in the last 2 years?"* (with web search on)

## Part B: Learn anything faster 🚀
...
| **Learning roadmap** | *"Create a 30-day plan to learn [skill] with 30 minutes/day, including resources and milestones."* |

### Learning modes built into the apps
Many assistants now ship **study or learning modes** that guide you step by step instead of handing over answers. Turn them on
when you actually want to *learn*.

## Part C: Read, watch, and listen smarter 📚

- **Books:** *"Give me the core argument of [book], the 5 key ideas, and the strongest criticism of it."* Then decide if it's worth reading in full (often yes!).
- **Papers:** upload the PDF: *"Explain this paper to a smart non-expert, then list its limitations."*
- **Videos and lectures:** transcript → *"study notes with timestamps + 10 quiz questions."*
- **Podcasts:** NotebookLM or transcripts → key ideas → your notes ([Ch. 25](../part-6-knowledge-and-memory/25-personal-knowledge-management.md)).
- **Languages:** voice-mode conversation partners, plus *"correct my writing and explain each fix."*

## Part D: Don't let AI make you dumber 🧠💪
...
AI should be a **gym spotter**, not the one lifting the weights. 🏋️
...
**Next:** [33 · AI for Writing & Content Creators →](33-writing-and-content.md)

...
Become a builder, even if you've never coded: coding agents, Git and GitHub, the Claude Code masterclass and power-ups,
...
| If you… | Read |
|---|---|
| Are new to all of this | [Agents & Coding Tools](60-agents-and-coding-tools.md) → [Git & GitHub](61-git-and-github.md) |
| Want to master Claude Code | [Claude Code Masterclass](62-claude-code-masterclass.md) → [Claude Code Power-Ups](63-claude-code-power-ups.md) |
| Prefer an editor like VS Code | [Cursor & AI IDEs](64-cursor-and-ai-ides.md) |
| Want to ship a real app | [Vibe Coding](65-vibe-coding-your-first-app.md) → [Deploying & Hosting](66-deploying-and-hosting.md) |
| Want to understand agents deeply | [Calling AI APIs](67-calling-ai-apis.md) → [Build Your Own Agent](68-build-your-own-agent.md) → [Agent Frameworks](69-agent-frameworks-tour.md) → [Multi-Agent Systems](70-multi-agent-systems.md) |
| Want AI to use websites for you | [Computer Use & Browser Agents](71-computer-use-and-browser-agents.md) |
...
-   **[60 · Agents & AI Coding Tools: Become a Builder 🛠️🤖](60-agents-and-coding-tools.md)**
...
-   **[61 · Git & GitHub for AI Builders 🌳🐙](61-git-and-github.md)**
...
-   **[62 · The Claude Code Masterclass 🧑‍💻🤖](62-claude-code-masterclass.md)**
...
-   **[63 · Claude Code Power-Ups: Skills, Subagents, Hooks, Plugins & More ⚡🧙](63-claude-code-power-ups.md)**
...
-   **[64 · Cursor & AI IDEs: Coding Side by Side with AI 🖱️✨](64-cursor-and-ai-ides.md)**
...
-   **[65 · Vibe Coding Your First Real App 🎸💻](65-vibe-coding-your-first-app.md)**
...
-   **[66 · Deploying & Hosting: Put Your Creation on the Internet 🌍🚀](66-deploying-and-hosting.md)**
...
-   **[67 · Calling AI APIs Directly 🔑🐍](67-calling-ai-apis.md)**
...
-   **[68 · Build Your Own Agent 🤖🔧](68-build-your-own-agent.md)**
...
-   **[69 · Agent Frameworks Tour: Pick Your LEGO Set 🧱🤖](69-agent-frameworks-tour.md)**
...
-   **[70 · Multi-Agent Systems: Teams of AIs 👥🤖](70-multi-agent-systems.md)**
...
-   **[71 · Computer Use & Browser Agents: AI That Clicks for You 🖱️🌐](71-computer-use-and-browser-agents.md)**

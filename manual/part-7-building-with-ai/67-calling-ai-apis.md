...
| Field | Meaning |
|---|---|
| `model` | Which model. Tiers trade capability for speed and cost ([How Models Really Work](../part-3-foundations/33-how-models-really-work.md)) |
...
long-running bots ([Context Engineering](../part-3-foundations/36-context-engineering.md)).
...
Want to see the loop *without* the helper? That's exactly what [Build Your Own Agent](68-build-your-own-agent.md) and the
...
More in [Cost Optimization](../part-12-mastery/106-cost-optimization.md).
...
| **Local models** (Ollama, LM Studio) | Free, private HTTP APIs on your own machine ([Local & Open Models](../part-9-local-ai/78-local-and-open-models.md)) |
...
- **Web apps:** API routes, server actions or edge functions ([Vibe Coding](65-vibe-coding-your-first-app.md)).
- **Automations:** HTTP Request or Anthropic nodes in n8n, Zapier and Make ([Part V](../part-5-automation/index.md)).
...
**Next:** [68 · Build Your Own Agent →](68-build-your-own-agent.md)

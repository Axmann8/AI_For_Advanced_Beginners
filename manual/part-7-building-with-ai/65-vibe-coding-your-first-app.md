...
| 🌍 **Hosting** | Puts it on the internet | Vercel, Netlify, Cloudflare Pages (free tiers) ([Deploying & Hosting](66-deploying-and-hosting.md)) |
| 🐙 **Code home** | Versions, backups, collaboration | GitHub ([Git & GitHub](61-git-and-github.md)) |
| ✨ **AI features** | Smart bits inside your app | Claude API and friends ([Calling AI APIs](67-calling-ai-apis.md)) |
...
More in [Design & UI with AI](../part-10-creative-ai/90-design-and-ui.md).
...
code. The pattern is in [Calling AI APIs Directly](67-calling-ai-apis.md).
...
| Secrets leaked into GitHub | Rotate the key immediately ([Git & GitHub](61-git-and-github.md#-secrets--safety-the-stuff-that-bites-beginners)) |
...
**Next:** [66 · Deploying & Hosting →](66-deploying-and-hosting.md)

...
|---|---|---|---|
| 🖐️ **Hands** (tools) | The AI can *do* things: send email, create a Notion page, run code, click buttons | Tool use, function calling, MCP tools, actions | [MCP Explained](../part-2-mcp-and-connectors/07-mcp-explained.md) |
| 👀 **Eyes** (context) | The AI can *see* your stuff: files, docs, calendar, codebase, the live web | Connectors, MCP resources, RAG, web search | [RAG, Memory & Knowledge](../part-6-knowledge-and-memory/41-rag-memory-and-knowledge.md) |
| 🧠 **Memory** | The AI remembers across conversations | Projects, memory, `CLAUDE.md`, vector databases | [Memory for Agents](../part-6-knowledge-and-memory/44-memory-for-agents.md) |
| 🔁 **Loops** (agency) | The AI works through multi-step tasks, checks its own work, and keeps going | Agents, agent loops, agentic workflows | [Build Your Own Agent](../part-5-building-with-ai/37-build-your-own-agent.md) |
...
tools in [Building MCP Servers](../part-2-mcp-and-connectors/11-building-mcp-servers.md).
...
1. **Context is king.** Most "the AI is dumb" moments are really "the AI couldn't see what I was looking at" moments.
   Connectors, MCP, attached files and memory all fix this. (Deep dive: [Context Engineering](05-context-engineering.md).)

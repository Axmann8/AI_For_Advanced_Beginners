# 04 · The AI Landscape: Who's Who 🗺️🏢
...
> test on your own tasks ([Evaluating & Comparing AI](../part-10-mastery/74-evaluating-ai.md)).
...
- **Your own machine:** Ollama and LM Studio run open models on your laptop ([Part VII](../part-7-local-ai/index.md)).
...
| **Q4, Q8, GGUF, MLX** | **Quantized** or packaged for local use ([Local & Open Models](../part-7-local-ai/47-local-and-open-models.md)) |
...
- **Your personal eval:** 10 real tasks you care about, re-run when something new ships ([Evaluating & Comparing AI](../part-10-mastery/74-evaluating-ai.md)).
- A light news diet: [Staying Current](../part-10-mastery/79-staying-current.md).
...
More in [Where This Is All Heading](../part-10-mastery/80-where-this-is-heading.md).
...
**Next:** [05 · Context Engineering →](05-context-engineering.md)

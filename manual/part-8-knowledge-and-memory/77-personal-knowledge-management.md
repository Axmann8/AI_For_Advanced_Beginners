...
| **Notion** ([Notion AI Deep Dive](../part-6-ai-in-your-apps/54-notion-ai-deep-dive.md)) | Databases, teams, polish | Notion Agent + Custom Agents, official MCP |
...
| Source | Pipeline |
|---|---|
| 🎙️ **Voice ideas** | Phone shortcut or Action Button → webhook → AI cleanup → Inbox ([Phone & Desktop Automation](../part-5-automation/50-phone-and-desktop-automation.md)) |
...
([Embeddings & Vector Databases](73-embeddings-and-vector-databases.md#-beyond-rag-10-things-embeddings-can-do)).
...
=== "🔒 Private (a weekend)"
    ...
    - **AI:** Ollama + a local model, local embeddings for search ([Local & Open Models](../part-9-local-ai/78-local-and-open-models.md))
    - **Nothing leaves your machine** 🔐

The full build is in [Build-Along: Your Second Brain](../part-13-build-alongs/114-build-along-second-brain.md).
...
7. **Protect the private stuff.** Journals and health notes deserve local AI or careful settings ([Privacy & Your Data](../part-12-mastery/104-privacy-and-your-data.md)).
...
**Next:** [78 · Local & Open Models →](../part-9-local-ai/78-local-and-open-models.md)

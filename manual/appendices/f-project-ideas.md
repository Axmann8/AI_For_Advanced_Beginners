# Appendix F · 80 Project Ideas to Level Up 🚀

> ⏱️ 12 min read · 🎯 Everyone who learns by building · 🧰 Needs: curiosity and a free afternoon

**Reading is great, but building is where it sticks.** Here are 80 projects, from 🟢 weekend-afternoon to 🔴 ambitious, plus
ideas sorted by passion. Every one teaches something real, and most link to the chapter or build-along that shows you how.
...
| # | If you love… | Build |
|---|---|---|
| 66 | 🐶 **Pets** | A pet-care tracker with vet reminders and a pet-portrait LoRA |
| 67 | ⚽ **Sports** | A match-day bot with stats, predictions and banter for your group chat |
| 68 | 🎸 **Music** | A practice companion: stems, slow-down, chord charts and a progress log |
| 69 | 🍲 **Cooking** | A family cookbook app from scanned recipe cards with "what can I make?" |
| 70 | 🌱 **Gardening** | A garden planner + planting calendar + diary with plant-ID photos |
| 71 | 📚 **Reading** | A reading tracker that connects new books to your old notes |
| 72 | 🥾 **Hiking** | A trip planner with weather (your MCP server!), packing lists and a trail journal |
| 73 | 🎲 **Board games** | A rules-lookup bot from rulebook PDFs for game night |
| 74 | 👵 **Family history** | A searchable archive of scanned letters with a family timeline |
| 75 | 🧶 **Crafts** | A pattern helper that turns photos into step-by-step instructions |
| 76 | 🏃 **Fitness** | A coach with memory that adapts your plan weekly |
| 77 | 🎮 **Gaming** | A tiny game jam: one mechanic, one weekend, one friend to play-test |
| 78 | 🌍 **Languages** | A voice conversation partner that remembers your mistakes |
| 79 | 🧑‍🏫 **Teaching** | A lesson-plan generator with differentiated reading levels |
...
| Week | Focus | Projects |
|---|---|---|
| 1 | Connectors & MCP basics | #1, #3, #5, #36 |
| 2 | Automations | #16, #17, #18 |
| 3 | Build with agents | #25, #33, #38 |
| 4 | Knowledge & capstone | #21, #41 + pick one from 🔴 |

Share what you build! Post in communities like r/ClaudeAI, r/n8n, r/LocalLLaMA or the MCP Discord. People love seeing real
projects, and you'll learn tons from the replies. 🎉

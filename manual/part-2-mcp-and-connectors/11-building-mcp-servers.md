# 11 · Building MCP Servers: The Deep Dive 🏗️🔌
...
> *"help me build this."* That's the whole point of [Part V](../part-5-building-with-ai/index.md). 😄
...
- **Where to host:** Cloudflare Workers (MCP templates available), Vercel, Fly.io, Railway, Render, Google Cloud Run, AWS
  Lambda, or a small VPS ([Deploying & Hosting](../part-5-building-with-ai/35-deploying-and-hosting.md)).
...
([Claude Code Power-Ups](../part-5-building-with-ai/32-claude-code-power-ups.md)).
...
**Next:** [12 · MCP Security & Trust →](12-mcp-security-and-trust.md)

...
| 🔎 Research | Deep research, source finding, fact-checks | Judging credibility ([Research & Learning](91-research-and-learning.md)) |
...
2. Ask: *"Analyze my writing style: sentence length, vocabulary, tone, humor, structure, quirks. Write a style guide I can
   reuse."*
3. Save the style guide in a **Project**, custom instructions, or a **skill** ([Claude Code Power-Ups](../part-7-building-with-ai/63-claude-code-power-ups.md#-skills-packaged-expertise)).
...
```mermaid
flowchart LR
    L[📝 Long-form piece] --> T[🧵 Thread]
    L --> LI[💼 LinkedIn]
    L --> C[🖼️ Carousel]
    L --> V[🎬 Short video script]
    L --> N[📧 Newsletter]
    L --> Q[💬 Quote graphics]
```

**Automate it:** new post → AI repurposes → drafts land in Buffer or Notion **for your review** ([Zapier & Make](../part-5-automation/49-zapier-and-make-walkthroughs.md),
[Build-Along: Automated Newsletter](../part-13-build-alongs/118-build-along-automated-newsletter.md)).
...
| 📄 **Résumés** | *"Tailor my résumé bullets to this job description. Quantify impact. Don't invent anything."* ([Careers](94-careers-and-job-hunting.md)) |
| 💰 **Grants & proposals** | *"Check this proposal against the funder's criteria and score each section."* |
| 📚 **Fiction** | Brainstorm, interview characters, check continuity, and write the prose yourself ([Storytelling](../part-10-creative-ai/89-storytelling-and-interactive-fiction.md)) |
...
| Visuals | Canva AI, Ideogram, Midjourney ([Image Generation](../part-10-creative-ai/84-image-generation-deep-dive.md)) |
| Video & audio | Descript, CapCut, ElevenLabs ([Video & Audio](../part-10-creative-ai/85-video-and-audio-production.md)) |
| Scheduling | Buffer, Typefully, Later |
| Ideas & research | Perplexity, deep research, your second brain ([Personal Knowledge Management](../part-8-knowledge-and-memory/77-personal-knowledge-management.md)) |
...
**Next:** [93 · AI for Small Business & Side Hustles →](93-small-business.md)

# 56 · Voice Agents: AI You Can Talk To (and That Can Call You) 📞🗣️
...
4. **Tools:** connect `check_availability` and `book_appointment`. Most platforms call a **webhook**, so point them at n8n or
   Make workflows that talk to Google Calendar ([Webhooks, APIs & JSON](../part-3-automation/15-webhooks-apis-json.md)).
...
The full, polished version is [Build-Along: Voice Receptionist](../part-11-build-alongs/88-build-along-voice-receptionist.md).
...
| 🗣️ **Language tutor** that remembers your mistakes | Realtime voice model + memory store ([Memory for Agents](../part-6-knowledge-and-memory/44-memory-for-agents.md)) |
| 🍳 **Hands-free kitchen assistant** | Voice agent + recipe RAG ([Build a RAG System](../part-6-knowledge-and-memory/43-build-a-rag-system.md)) |
| 🎲 **Interactive audio adventure** | Voice agent as narrator + dice tool ([Storytelling](58-storytelling-and-interactive-fiction.md)) |
| 📋 **Voice-to-task inbox** | Dictation → n8n → task app |
| ☎️ **After-hours line for a small business** | Phone agent + FAQ + message-taking ([Small Business](../part-9-ai-for-life-and-work/62-small-business.md)) |
| 🏡 **Private home voice assistant** | Local STT + local LLM + Home Assistant ([Build-Along](../part-11-build-alongs/86-build-along-private-home-assistant.md)) |
...
**Next:** [57 · 3D, Games & Interactive Worlds →](57-3d-games-and-worlds.md)

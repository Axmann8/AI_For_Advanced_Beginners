# 59 · Design & UI with AI: Make Things Look Wonderful 🎨📐
...
| 🔌 **Design ↔ code bridge** | **Figma MCP server**, Canva MCP | Coding agents read your real designs ([Cursor & AI IDEs](../part-5-building-with-ai/33-cursor-and-ai-ides.md)) |
...
> ([Claude Code Power-Ups](../part-5-building-with-ai/32-claude-code-power-ups.md#-mcp-in-claude-code)).
...
More in [Accessibility & AI](../part-9-ai-for-life-and-work/70-accessibility-and-ai.md).
...
| **Invitations & cards** | Image model art + clean typography in Canva ([Image Generation](53-image-generation-deep-dive.md)) |
...
| 3 | 🏠 A personal homepage, from moodboard to deployed site ([Deploying & Hosting](../part-5-building-with-ai/35-deploying-and-hosting.md)) |
...
| 11 | 📚 A book cover for your story ([Storytelling](58-storytelling-and-interactive-fiction.md)) |

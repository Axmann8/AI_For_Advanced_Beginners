...
2. **Storyboard frames:** generate one image per shot with a **consistent style and character reference** ([Ch. 29](53-image-generation-deep-dive.md)).
...
5. **Automate distribution** with Make/Zapier: publish → auto-generate a description, tags, and social posts ([Ch. 11](../part-3-automation/18-zapier-and-make-walkthroughs.md)).
...
**Next:** [31 · Voice Agents →](56-voice-agents.md)

# 57 · 3D, Games & Interactive Worlds 🎮🧊
...
|---|---|---|
| 💻 **Code** | Writing game logic, physics, menus, bug fixes | Claude Code, Cursor, chat-to-app builders ([Agents & Coding Tools](../part-5-building-with-ai/29-agents-and-coding-tools.md)) |
| 🖼️ **2D art** | Sprites, tiles, backgrounds, UI | Image models ([Image Generation](53-image-generation-deep-dive.md)) |
| 🧊 **3D models** | Characters, props, environments | Text/image-to-3D tools, Blender + MCP |
| 🎵 **Music & SFX** | Soundtracks, jingles, sound effects | Suno, ElevenLabs SFX ([Music Making](55-music-making-with-ai.md)) |
| 🗣️ **Characters** | Living dialogue, voices | LLM-powered NPCs, TTS ([Voice Agents](56-voice-agents.md)) |
| 📖 **Story** | Quests, lore, branching plots | Claude ([Storytelling](58-storytelling-and-interactive-fiction.md)) |
...
| **Claude Code / Cursor** | Real projects you keep growing ([Claude Code Masterclass](../part-5-building-with-ai/31-claude-code-masterclass.md)) |
...
call. Start with backups, and review scripts before running them ([MCP Security & Trust](../part-2-mcp-and-connectors/12-mcp-security-and-trust.md)).
...
- **Memory:** characters remember what the player did ([Memory for Agents](../part-6-knowledge-and-memory/44-memory-for-agents.md)).
...
**Next:** [58 · Storytelling & Interactive Fiction →](58-storytelling-and-interactive-fiction.md)

...
4. **Tools:** connect `check_availability` and `book_appointment`. Most platforms call a **webhook**, so point them at
   **n8n or Make** workflows that talk to Google Calendar ([Ch. 12](../part-3-automation/12-webhooks-apis-json.md)).
...
| 🍳 Hands-free kitchen assistant | Voice agent + recipe RAG ([Ch. 24](../part-6-knowledge-and-memory/24-build-a-rag-system.md)) |
| 🎲 Interactive audio adventure game | Voice agent as a narrator + dice tool |
| 📋 Voice-to-task inbox | Dictation → n8n → task app |
| ☎️ After-hours line for a small business | Phone agent + FAQ + message-taking ([Ch. 34](../part-9-ai-for-life-and-work/34-small-business.md)) |
...
**Next:** [32 · AI for Research & Learning →](../part-9-ai-for-life-and-work/32-research-and-learning.md)

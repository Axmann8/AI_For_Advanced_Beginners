...
```mermaid
flowchart LR
    Q[AI answer] --> S{How bad if<br/>it's wrong?}
    S -->|"Not at all 🟢"| G[Use it]
    S -->|"A bit awkward 🟡"| Y[Quick check]
    S -->|"Serious 🔴"| R[Confirm with a<br/>pro or official source]
```
...
<details class="quiz">
<summary>❓ 1. AI gives you a perfect-sounding quote from a famous scientist for your presentation. What do you do?</summary>
...
<details class="quiz">
<summary>❓ 2. Which traffic light: "What dose of children's paracetamol for my 4-year-old?"</summary>
...
<details class="quiz">
<summary>❓ 3. You challenge the AI and it immediately says "You're absolutely right!" Should you trust that?</summary>
...
<details class="quiz">
<summary>❓ 4. What's the easiest way to get more reliable answers about current events?</summary>

...
```mermaid
flowchart TD
    A["📞 Urgent call or message<br/>asking for money or info"] --> B{"Pressure, secrecy<br/>or panic?"}
    B -->|Yes| C["🛑 STOP. Don't pay, don't click"]
    C --> D["☎️ Contact the person or company<br/>on a number YOU already know"]
    D --> E["🔑 Ask for the family safe word"]
    B -->|No| F["Still verify anything<br/>involving money"]
```
...
<details class="quiz">
<summary>❓ 1. "Your daughter" calls from an unknown number, crying, saying she needs money wired right now. What do you do?</summary>
...
<details class="quiz">
<summary>❓ 2. A video of a famous businessman promotes an "AI trading platform guaranteeing 30% monthly returns." Real?</summary>
...
<details class="quiz">
<summary>❓ 3. Is it okay to paste your bank statement into a chatbot to get budgeting help?</summary>
...
<details class="quiz">
<summary>❓ 4. Can you reliably tell AI-written emails apart by spelling mistakes?</summary>

...
flowchart TD
    ...
    A -->|iPhone or doesn't matter| B{What do you mostly<br/>want help with?}
    B -->|A bit of everything| C["💬 ChatGPT"]
    B -->|Writing & long documents| D["🧡 Claude"]
    B -->|Research with sources| E["🔎 Perplexity"]
    B -->|Work in Word/Excel/Outlook| F["🪟 Copilot"]
    B -->|Chatting inside WhatsApp| H["👓 Meta AI"]
```
...
<details class="quiz">
<summary>❓ 1. You use an Android phone, Gmail and Google Calendar. Which assistant is the easiest start?</summary>
...
<details class="quiz">
<summary>❓ 2. Do you need to pay to learn AI properly?</summary>
...
<details class="quiz">
<summary>❓ 3. Your friend wants to use a free AI to summarize confidential work documents. What should they consider?</summary>
...
<details class="quiz">
<summary>❓ 4. What's the simplest way to pick between two assistants?</summary>

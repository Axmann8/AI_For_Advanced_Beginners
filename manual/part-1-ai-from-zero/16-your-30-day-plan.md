...
```mermaid
flowchart TD
    A["🎓 You, after 30 days"] --> B["🤖 Master your assistant<br/>Part II · Field Guide"]
    A --> C["🧠 Understand it deeply<br/>Part III · Foundations"]
    A --> D["🔌 Connect & automate<br/>Parts IV–VI"]
    A --> E["🛠️ Build apps & agents<br/>Part VII"]
    A --> F["🎨 Create art, music, video<br/>Part X"]
    A --> G["🌱 Real-life superpowers<br/>Part XI"]
```
...
<details class="quiz">
<summary>❓ 1. You missed three days of the plan. What should you do?</summary>
...
<details class="quiz">
<summary>❓ 2. Which part of the manual helps you master your specific assistant?</summary>
...
<details class="quiz">
<summary>❓ 3. What's the clearest sign you're ready for the advanced parts?</summary>

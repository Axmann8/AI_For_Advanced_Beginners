...
| **Home Assistant** | Smart home + AI (it has an MCP server!) | Separate install, then connect ([Ch. 5](../part-2-mcp-and-connectors/09-mcp-server-catalog.md)) |
...
mode. Score them blind. You'll develop real intuition for model differences. ([Ch. 38](../part-10-mastery/74-evaluating-ai.md))

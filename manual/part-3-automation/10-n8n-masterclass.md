...
| **Home lab bundle** | [`examples/homelab`](../../examples/homelab/) | n8n + Ollama + Open WebUI together ([Ch. 27](../part-7-local-ai/27-home-lab.md)) |
...
That's a "chat with my documents" bot, auto-updating as files land in the folder. (Concepts in [Ch. 23](../part-6-knowledge-and-memory/23-rag-memory-and-knowledge.md).)
...
**Next:** [11 · Zapier & Make Walkthroughs →](11-zapier-and-make-walkthroughs.md)

...
([n8n AI Agents Deep Dive](17-n8n-ai-agents.md)) goes all-in on agents.
...
| **Home lab bundle** | [`examples/homelab`](../../examples/homelab/) | n8n + Ollama + Open WebUI together ([The AI Home Lab](../part-7-local-ai/49-home-lab.md)) |
...
| **Webhook** | Receive data from anywhere ([Webhooks, APIs & JSON](15-webhooks-apis-json.md)) |
...
| **Basic LLM Chain / AI Agent** | Add AI thinking ([n8n AI Agents](17-n8n-ai-agents.md)) |
...
| 7 | 📚 Drive RAG bot in Slack ([n8n AI Agents](17-n8n-ai-agents.md)) | 🔴 |
...
**Next:** [17 · n8n AI Agents Deep Dive →](17-n8n-ai-agents.md)

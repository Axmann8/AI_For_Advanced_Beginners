# 14 · Automation Platforms: AI That Works While You Sleep ⚙️🌙
...
- **Go deeper:** [The n8n Masterclass](16-n8n-masterclass.md) → [n8n AI Agents Deep Dive](17-n8n-ai-agents.md).
...
- **Go deeper:** [Zapier & Make Walkthroughs](18-zapier-and-make-walkthroughs.md).
...
| **Google Apps Script + Gemini** | Free automation inside Google Workspace ([Google & Microsoft AI](../part-4-ai-in-your-apps/24-google-and-microsoft-ai.md)) |
| **Apple Shortcuts / Android Tasker** | Phone automations that can call AI models and webhooks ([Phone & Desktop Automation](19-phone-and-desktop-automation.md)) |
...
**50 more in [The Automation Recipe Book](21-automation-recipe-book.md).**
...
- **Ask the AI for JSON** when the next step needs structure, and parse it ([Webhooks, APIs & JSON](15-webhooks-apis-json.md)).
...
- **Set API spend limits** before activating anything that calls AI in a loop ([Cost Optimization](../part-10-mastery/75-cost-optimization.md)).
...
**Next:** [15 · Webhooks, APIs & JSON for Non-Programmers →](15-webhooks-apis-json.md)

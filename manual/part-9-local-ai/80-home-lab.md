...
| 🎨 **ComfyUI** | Local image generation (NVIDIA recommended) | A ComfyUI container ([Image Generation](../part-10-creative-ai/84-image-generation-deep-dive.md)) |
| 🏡 **Home Assistant** | Smart home + AI (it has an MCP server!) | Separate install, then connect ([Private Home Assistant](../part-13-build-alongs/117-build-along-private-home-assistant.md)) |
...
laptop on ([Automation Recipe Book](../part-5-automation/52-automation-recipe-book.md)).
...
prompts. Score them blind. You'll develop real intuition for model differences ([Evaluating AI](../part-12-mastery/105-evaluating-ai.md)).
...
that you control ([Parents, Teachers & Students](../part-11-ai-for-life-and-work/98-parents-teachers-and-students.md)).
...
**Next:** [81 · Local AI for Coding & Agents →](81-local-ai-for-coding-and-agents.md)

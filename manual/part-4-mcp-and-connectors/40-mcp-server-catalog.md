...
> [MCP Explained](38-mcp-explained.md#-installing-servers-app-by-app).
...
> More in [MCP Security & Trust](43-mcp-security-and-trust.md).
...
> humans. See [Health, Fitness & Wellbeing](../part-11-ai-for-life-and-work/97-health-fitness-and-wellbeing.md) and
> [Money & Personal Finance](../part-11-ai-for-life-and-work/96-money-and-personal-finance.md).
...
| **n8n** (MCP Server Trigger + instance MCP) | Turn *any n8n workflow* into an MCP tool, or let AI build workflows ([n8n AI Agents](../part-5-automation/48-n8n-ai-agents.md)) |
...
Full checklist in [MCP Security & Trust](43-mcp-security-and-trust.md).
...
> files. 🎉 More combos in [The MCP Recipe Book](44-mcp-recipe-book.md).

---

**Next:** [41 · Built-in Connectors & Plugins →](41-built-in-connectors.md)

# 85 · Build-Along: A Research Agent That Writes Reports 🔎📄
...
add features, test it offline, and schedule weekly reports. It's the agent loop from [Build Your Own Agent](../part-5-building-with-ai/37-build-your-own-agent.md),
doing real work. 🧑‍🔬
...
- Open **two citations**. Do they say what the report claims? ([Research & Learning](../part-9-ai-for-life-and-work/60-research-and-learning.md#-checking-sources-like-a-pro))
...
=== "🐙 GitHub Actions"
    ...
    or emails it ([Git & GitHub](../part-5-building-with-ai/30-git-and-github.md#-github-actions-robots-that-work-for-you)).

Pair it with the email feature and you have a personal research newsletter
([Build-Along: The Automated Newsletter](87-build-along-automated-newsletter.md)). ☕
...
| **Spend limit** in the console | Research loops can surprise you ([Cost Optimization](../part-10-mastery/75-cost-optimization.md)) |

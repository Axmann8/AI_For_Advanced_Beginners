...
|---|---|---|---|
| [Your Pocket AI Assistant on Telegram](81-build-along-pocket-ai-assistant.md) | 🟢🟡 | n8n, Claude, Google Calendar, memory | ~3 hours |
| [Publish Your Own MCP Server](82-build-along-publish-an-mcp-server.md) | 🟡 | Node.js, MCP SDK, npm, the MCP Registry | ~3 hours |
| [The Second Brain](83-build-along-second-brain.md) | 🟢 | Obsidian, Claude Code, skills, automations | ~2 hours |
| [A Web App with Logins & AI](84-build-along-web-app-with-ai.md) | 🟡🔴 | Claude Code, Supabase, Vercel, Claude API | a weekend |
| [A Research Agent That Writes Reports](85-build-along-research-agent.md) | 🟡 | Python, Claude API, web search | ~3 hours |
| [The Private Home Assistant](86-build-along-private-home-assistant.md) | 🟡 | Docker, Ollama, Open WebUI, RAG | ~3 hours |
| [The Automated Newsletter](87-build-along-automated-newsletter.md) | 🟢🟡 | RSS, n8n or Python, Claude, email | ~2 hours |
| [An AI Voice Receptionist](88-build-along-voice-receptionist.md) | 🟡🔴 | Voice platform, n8n, Google Calendar | a weekend |
...
-   **[81 · Build-Along: Your Pocket AI Assistant on Telegram 📱🤖](81-build-along-pocket-ai-assistant.md)**
...
-   **[82 · Build-Along: Publish Your Own MCP Server ☔📦](82-build-along-publish-an-mcp-server.md)**
...
-   **[83 · Build-Along: The Second Brain 🧠🗃️](83-build-along-second-brain.md)**
...
-   **[84 · Build-Along: A Web App with Logins & AI 🍲💻](84-build-along-web-app-with-ai.md)**
...
-   **[85 · Build-Along: A Research Agent That Writes Reports 🔎📄](85-build-along-research-agent.md)**
...
-   **[86 · Build-Along: The Private Home Assistant 🏡🔒](86-build-along-private-home-assistant.md)**
...
-   **[87 · Build-Along: The Automated Newsletter 📰💌](87-build-along-automated-newsletter.md)**
...
-   **[88 · Build-Along: An AI Voice Receptionist 📞🤖](88-build-along-voice-receptionist.md)**

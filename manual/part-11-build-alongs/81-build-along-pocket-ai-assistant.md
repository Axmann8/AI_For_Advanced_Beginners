# 81 · Build-Along: Your Pocket AI Assistant on Telegram 📱🤖
...
- [ ] **n8n** running: n8n Cloud, or self-hosted with a public HTTPS URL ([n8n Masterclass](../part-3-automation/16-n8n-masterclass.md)).
...
- [ ] An **Anthropic API key** with a **spend limit** set ([Safety, Costs & Gotchas](../part-10-mastery/72-safety-costs-and-gotchas.md)).
...
2. The model is set to `claude-opus-5`. For a cheaper, faster assistant, pick a smaller model here ([Cost Optimization](../part-10-mastery/75-cost-optimization.md)).
...
([n8n AI Agents](../part-3-automation/17-n8n-ai-agents.md)).
...
| 🌦️ **Weather** | Add your [Weather Buddy MCP server](82-build-along-publish-an-mcp-server.md) via n8n's MCP Client Tool |
| 📚 **Your notes** | A vector store tool with your documents ([Build a RAG System](../part-6-knowledge-and-memory/43-build-a-rag-system.md)) |
| 🧠 **Long-term memory** | Swap Simple Memory for Postgres Chat Memory so memory survives restarts ([Memory for Agents](../part-6-knowledge-and-memory/44-memory-for-agents.md)) |

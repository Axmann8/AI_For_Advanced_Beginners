# 84 · Build-Along: A Web App with Logins & AI 🍲💻
...
Background: [Vibe Coding](../part-5-building-with-ai/34-vibe-coding-your-first-app.md), [Deploying & Hosting](../part-5-building-with-ai/35-deploying-and-hosting.md),
...
- [ ] **Claude Code** installed ([Claude Code Masterclass](../part-5-building-with-ai/31-claude-code-masterclass.md)), Node.js 20+
...
- *"Act as a senior product designer: screenshot every page at phone and desktop sizes with Playwright, critique against
  SPEC.md's look & feel, and fix the top 5 issues."* ([Design & UI](../part-8-creative-ai/59-design-and-ui.md))
- Add delight: an empty state with a friendly illustration, a little confetti when a remix is saved 🎉, and warm microcopy.
- Accessibility pass: contrast, labels, keyboard navigation ([Accessibility & AI](../part-9-ai-for-life-and-work/70-accessibility-and-ai.md)).
...
1. Create a **private GitHub repo** and push ([Git & GitHub](../part-5-building-with-ai/30-git-and-github.md)).

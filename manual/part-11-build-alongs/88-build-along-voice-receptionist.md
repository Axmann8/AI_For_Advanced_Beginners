# 88 · Build-Along: An AI Voice Receptionist 📞🤖
...
- [ ] A **voice-agent platform** account: Vapi, Retell or ElevenLabs Agents (free trials usually cover testing) ([Voice Agents](../part-8-creative-ai/56-voice-agents.md))
- [ ] **n8n** reachable over **HTTPS** (n8n Cloud, or self-hosted with a tunnel) ([n8n Masterclass](../part-3-automation/16-n8n-masterclass.md))
...
More on writing for the ear in [Voice Agents](../part-8-creative-ai/56-voice-agents.md#-writing-prompts-for-the-ear).
...
agent decides when to call it ([Build Your Own Agent](../part-5-building-with-ai/37-build-your-own-agent.md#-designing-great-tools)).
...
email or Telegram** ([Pocket AI Assistant](81-build-along-pocket-ai-assistant.md)).
...
More in [Safety, Costs & Gotchas](../part-10-mastery/72-safety-costs-and-gotchas.md) and [AI Ethics for Builders](../part-10-mastery/76-ai-ethics-for-builders.md).
...
| 📚 **Bigger knowledge** | Connect a knowledge base for detailed questions ([Build a RAG System](../part-6-knowledge-and-memory/43-build-a-rag-system.md)) |
| 💬 **Missed-call texts** | If a call drops, send an SMS with the booking link |
| 🧑‍💼 **Offer it as a service** | Local businesses love this ([Turning AI Skills into Income](../part-10-mastery/78-turning-ai-skills-into-income.md#-path-3-productized-services)) |

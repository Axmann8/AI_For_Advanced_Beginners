...
| Want privacy above all | **Local models** | Nothing leaves your machine ([Part IX](../part-9-local-ai/index.md)) |
...
- **Learning:** Gemini Notebook (formerly NotebookLM, free tier), study/learning modes ([Research & Learning](../part-11-ai-for-life-and-work/91-research-and-learning.md))
...
- **Automation:** iOS Shortcuts or Google Home routines ([Phone & Desktop Automation](../part-5-automation/50-phone-and-desktop-automation.md))
...
- **Hosting:** free tiers of Vercel, Supabase, Cloudflare ([Deploying & Hosting](../part-7-building-with-ai/66-deploying-and-hosting.md))

### 🔒 The Privacy-First Tinkerer ($0 + hardware)
- **Assistant:** Ollama + Open WebUI at home ([The AI Home Lab](../part-9-local-ai/80-home-lab.md)), plus a frontier model only for non-sensitive hard problems
...
- **Automation:** Make or Zapier for repurposing content ([Writing & Content](../part-11-ai-for-life-and-work/92-writing-and-content.md))
...
- **Customer-facing:** a support bot grounded in your docs ([Small Business](../part-11-ai-for-life-and-work/93-small-business.md))
...
> no automation? [Part V](../part-5-automation/index.md). No connections? [Part IV](../part-4-mcp-and-connectors/index.md).
> Future you will thank present you. 💜

---

**Next:** [38 · MCP Explained →](../part-4-mcp-and-connectors/38-mcp-explained.md)

# 113 · Build-Along: Publish Your Own MCP Server ☔📦
...
`Dockerfile`. Background reading: [Building MCP Servers](../part-4-mcp-and-connectors/42-building-mcp-servers.md).
...
> and log carefully ([MCP Security & Trust](../part-4-mcp-and-connectors/43-mcp-security-and-trust.md)). Weather is harmless,
...
| **CI** | A GitHub Action that runs `npm test` on every push ([Git & GitHub](../part-7-building-with-ai/61-git-and-github.md#-github-actions-robots-that-work-for-you)) |
...
**Next:** [114 · The Second Brain →](114-build-along-second-brain.md)

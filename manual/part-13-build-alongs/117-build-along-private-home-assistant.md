# 117 · Build-Along: The Private Home Assistant 🏡🔒
...
3. For kids, create a separate model (e.g. **"Hearth Junior"**) with simpler language and stricter guardrails
   ([Parents, Teachers & Students](../part-11-ai-for-life-and-work/98-parents-teachers-and-students.md)).
...
concert?"* ([RAG, Memory & Knowledge](../part-8-knowledge-and-memory/72-rag-memory-and-knowledge.md))
...
> ([Home Lab security](../part-9-local-ai/80-home-lab.md#-security-basics)).
...
| **MCP bridge** | Enable Home Assistant's **Model Context Protocol Server** integration, then connect MCP-capable clients to it | Asking any MCP app about your home ([MCP Server Catalog](../part-4-mcp-and-connectors/40-mcp-server-catalog.md)) |
...
| Try newer models | Quarterly | Model tasting night ([Evaluating AI](../part-12-mastery/105-evaluating-ai.md)) |
...
| Problem | Fix |
|---|---|
| Very slow answers | Use a smaller model, run Ollama natively on a Mac, or add a GPU ([Hardware](../part-9-local-ai/79-hardware-for-local-ai.md)) |
...
**Next:** [118 · The Automated Newsletter →](118-build-along-automated-newsletter.md)

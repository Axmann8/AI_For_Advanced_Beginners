# 74 · Evaluating & Comparing AI: Evals for Normal People 🧪⚖️
...
- **Tools that help:** promptfoo, n8n evaluations, Braintrust, LangSmith, Langfuse, Arize Phoenix, and the providers' own eval
  tooling ([Agent Frameworks Tour](../part-5-building-with-ai/38-agent-frameworks-tour.md#-tracing--observability)).
...
**Next:** [75 · Cost Optimization Deep Dive →](75-cost-optimization.md)

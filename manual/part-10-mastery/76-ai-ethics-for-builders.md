# 76 · AI Ethics for Builders: Build Things You're Proud Of 🌍🤝
...
|---|---|
| **Chatbots & voice agents** | Say it's AI at the start, and offer a human path ([Voice Agents](../part-8-creative-ai/56-voice-agents.md)) |
...
- **Personal data:** use people's data only in ways they'd reasonably expect, and let them opt out
  ([Privacy & Your Data](73-privacy-and-your-data.md#-privacy-for-builders)).
- **Private messages:** don't feed friends' or customers' private messages into AI without consent.
- **Training data:** only fine-tune on data you have rights to ([Fine-Tuning](../part-7-local-ai/51-fine-tuning-for-normal-people.md)).
...
4. Fix the prompt, the data or the design, and **re-test** ([Evaluating AI](74-evaluating-ai.md)).
...
- **Don't imitate living artists' signature styles** to compete with them; describe eras, media and moods instead
  ([Image Generation](../part-8-creative-ai/53-image-generation-deep-dive.md)).
- **Don't reproduce copyrighted work** (lyrics, articles, characters) for commercial use without rights.
- **Check commercial-use terms** of each tool ([Music Making](../part-8-creative-ai/55-music-making-with-ai.md#-rights-copyright--being-fair)).
- **Credit and pay** human collaborators, and hire artists for work that deserves a human touch.
- **Respect opt-outs** (robots.txt, "no AI training" requests) when scraping or collecting data ([Web Scraping](../part-3-automation/20-web-scraping-and-monitoring.md)).
...
- **Right-size models:** small models for simple tasks ([Cost Optimization](75-cost-optimization.md)).
...
- [ ] **Safe?** Are harmful or irreversible actions gated behind human approval? ([Safety, Costs & Gotchas](72-safety-costs-and-gotchas.md))
- [ ] **Accountable?** Is there a human owner, a log, and an appeal path?
- [ ] **Accessible?** Can people with disabilities use it? ([Accessibility & AI](../part-9-ai-for-life-and-work/70-accessibility-and-ai.md))
...
**Next:** [77 · Teaching Others About AI →](77-teaching-others.md)

# 72 · Safety, Costs & Gotchas: Play Hard, Play Smart 🛡️💸
...
non-existent citations, or library functions that don't exist ([How Models Really Work](../part-1-foundations/02-how-models-really-work.md)).

| Habit | Why it works |
|---|---|
| **Ground it** in sources (web search, your documents, RAG) | Answers come from real text ([RAG](../part-6-knowledge-and-memory/41-rag-memory-and-knowledge.md)) |
...
Deep dive: [MCP Security & Trust](../part-2-mcp-and-connectors/12-mcp-security-and-trust.md).
...
| **Rotate immediately** if exposed | Deleting the commit isn't enough ([Git & GitHub](../part-5-building-with-ai/30-git-and-github.md#-secrets--safety-the-stuff-that-bites-beginners)) |
...
- **Read plugin hooks** before installing: hooks run shell commands automatically ([Claude Code Power-Ups](../part-5-building-with-ai/32-claude-code-power-ups.md#-hooks-automatic-guardrails)).
...
| **Max turns and budgets** | Stop runaway loops ([Build Your Own Agent](../part-5-building-with-ai/37-build-your-own-agent.md)) |
| **Separate browser profiles** | Keep browser agents away from your bank and email ([Computer Use](../part-5-building-with-ai/40-computer-use-and-browser-agents.md)) |
...
| **Go local** for high-volume grunt work | Electricity only ([Local & Open Models](../part-7-local-ai/47-local-and-open-models.md)) |

> [!TIP]
> **💡 Token rule of thumb**
> ~1 token ≈ ¾ of an English word. **Output tokens usually cost several times more than input tokens.** Full playbook in
> [Cost Optimization](75-cost-optimization.md).
...
| **Context overload** in long chats | Start fresh (`/clear`), summarize, split tasks ([Context Engineering](../part-1-foundations/05-context-engineering.md)) |
| **Data policies** | Check your plan's retention and training settings ([Privacy & Your Data](73-privacy-and-your-data.md)) |
...
- **Ask AI for a second opinion:** *"Is this message a scam? What are the red flags?"* ([Money & Personal Finance](../part-9-ai-for-life-and-work/65-money-and-personal-finance.md#-scams--ai-powered-fraud))
...
- **Use AI to learn**, not just to finish ([Research & Learning](../part-9-ai-for-life-and-work/60-research-and-learning.md#-dont-let-ai-make-you-dumber)).
...
**Next:** [73 · Privacy & Your Data →](73-privacy-and-your-data.md)

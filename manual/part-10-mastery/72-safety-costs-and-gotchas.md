...
| **Go local** for high-volume grunt work | Ollama costs electricity only ([Ch. 26](../part-7-local-ai/47-local-and-open-models.md)) |
...
**Next:** [38 · Evaluating & Comparing AI (Evals for Normal People) →](74-evaluating-ai.md)

...
| **Local models for grunt work** | Ollama handles high-volume, low-stakes tasks for the cost of electricity ([Ch. 26](../part-7-local-ai/47-local-and-open-models.md)) |

> 💡 **Measure before downgrading.** Run your eval set ([Ch. 38](74-evaluating-ai.md)) on the cheaper option. Judge **cost per
...
**Next:** [40 · Staying Current Without Drowning →](79-staying-current.md)

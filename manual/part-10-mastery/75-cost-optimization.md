# 75 · Cost Optimization Deep Dive: Same Magic, Smaller Bill 💸📉

> ⏱️ 6 min read · 🎯 Anyone paying for AI subscriptions, APIs or automation platforms · 🧰 Needs: access to your usage dashboards, and ideally an eval set ([Evaluating AI](74-evaluating-ai.md))
...
([Calling AI APIs](../part-5-building-with-ai/36-calling-ai-apis.md#-make-it-cheap--fast)).
...
| **Local models for grunt work** | High-volume, low-stakes tasks for the cost of electricity ([Local & Open Models](../part-7-local-ai/47-local-and-open-models.md)) |
...
> retries isn't cheap ([Evaluating AI](74-evaluating-ai.md)).
...
model **plans** while small models **execute** the steps ([Multi-Agent Systems](../part-5-building-with-ai/39-multi-agent-systems.md)).
...
| **n8n Cloud** | Executions (whole runs) | Complex workflows cost the same per run. Self-hosting removes limits ([n8n Masterclass](../part-3-automation/16-n8n-masterclass.md)) |
...
**Next:** [76 · AI Ethics for Builders →](76-ai-ethics-for-builders.md)

# 79 · Staying Current Without Drowning 🌊📰
...
| **Quarterly** | 1 hour | Re-evaluate your stack ([Choosing Your AI Stack](../part-1-foundations/06-choosing-your-ai-stack.md)) and re-run your personal eval ([Evaluating AI](74-evaluating-ai.md)) |
...
| **This manual's Build-Alongs** | Hands-on projects ([Part XI](../part-11-build-alongs/index.md)) |
...
build: [Build-Along: Automated Newsletter](../part-11-build-alongs/87-build-along-automated-newsletter.md).)
...
After a few months it becomes a gold mine, and great material to share ([Teaching Others](77-teaching-others.md)).
...
**Next:** [80 · Where This Is All Heading →](80-where-this-is-heading.md)

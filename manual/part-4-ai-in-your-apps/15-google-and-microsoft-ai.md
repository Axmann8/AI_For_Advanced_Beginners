...
| **NotebookLM** | Grounded research and audio overviews from your sources | See [Ch. 23](../part-6-knowledge-and-memory/23-rag-memory-and-knowledge.md) |
...
- **Claude:** Google Drive, Gmail, and Calendar connectors ([Ch. 6](../part-2-mcp-and-connectors/06-built-in-connectors.md)).
...
Do it once with the built-in AI this week. If it saves 10+ minutes, automate it next week using [Part III](../part-3-automation/09-automation-platforms.md).

---

**Next:** [16 · Obsidian + AI →](16-obsidian-and-ai.md)

# 25 · Obsidian + AI: Your Local-First Thinking Machine 🟪🧠
...
full file-system skills (grep, bulk edits, scripts) ([Claude Code Masterclass](../part-5-building-with-ai/31-claude-code-masterclass.md)).
...
([Phone & Desktop Automation](../part-3-automation/19-phone-and-desktop-automation.md)).
...
**Next:** [26 · Email & Calendar Superpowers →](26-email-and-calendar.md)

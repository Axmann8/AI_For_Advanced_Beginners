# 22 · AI Inside the Apps You Already Use 🏡✨
...
|---|---|---|
| **Notion** | Notion Agent, Custom Agents on schedules, AI meeting notes, database autofill, MCP both ways | [Notion AI Deep Dive](23-notion-ai-deep-dive.md) |
| **Obsidian** | Community AI plugins, local models, MCP and Claude Code access to your Markdown vault | [Obsidian + AI](25-obsidian-and-ai.md) |
| **Google Docs** | Gemini drafting, rewriting, summarizing, "help me create" from your files | [Google & Microsoft AI](24-google-and-microsoft-ai.md) |
| **Microsoft Word** | Copilot drafting from files, rewriting, Q&A on long docs | [Google & Microsoft AI](24-google-and-microsoft-ai.md) |
| **Coda, Craft, Mem, Reflect, Capacities** | AI columns, AI-native note organization, chat with notes | [Personal Knowledge Management](../part-6-knowledge-and-memory/46-personal-knowledge-management.md) |
...
Everything else in [Spreadsheet Superpowers](27-spreadsheet-superpowers.md).
...
Full playbook: [Email & Calendar Superpowers](26-email-and-calendar.md).
...
| App | AI highlights | Deep dive |
|---|---|---|
| **Canva** | Magic design, image generation, brand kits, resize for every platform, MCP connector | [Design & UI with AI](../part-8-creative-ai/59-design-and-ui.md) |
| **Figma** | AI design features, Dev Mode MCP for coding agents | [Design & UI with AI](../part-8-creative-ai/59-design-and-ui.md) |
| **Adobe (Photoshop, Firefly, Express)** | Generative fill, expand, commercially safe generation | [Image Generation](../part-8-creative-ai/53-image-generation-deep-dive.md) |
| **CapCut / Descript** | Edit video by editing text, auto-captions, voice cleanup | [Video & Audio](../part-8-creative-ai/54-video-and-audio-production.md) |
...
Build your own magic buttons in [Phone & Desktop Automation](../part-3-automation/19-phone-and-desktop-automation.md).
...
- **NotebookLM:** grounded chat with your sources, audio and video overviews, quizzes ([NotebookLM Masterclass](../part-6-knowledge-and-memory/45-notebooklm-masterclass.md)).
...
1. **Pipe things into it** with automations ([Part III](../part-3-automation/index.md)).
2. **Let AI read and write it** via connectors or MCP ([Part II](../part-2-mcp-and-connectors/index.md)).
3. **Ask questions across it** with RAG or built-in search ([Part VI](../part-6-knowledge-and-memory/index.md)).
...
**Next:** [23 · Notion AI Deep Dive →](23-notion-ai-deep-dive.md)

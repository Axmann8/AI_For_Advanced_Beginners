...
- **Upload to an assistant with code execution** (Claude, ChatGPT, Gemini): *"Clean this, find the top 3 insights, and make a
  chart for each."* Behind the scenes, it writes and runs Python ([Data Analysis for Everyone](../part-9-ai-for-life-and-work/71-data-analysis.md)).
...
Google Sheets, Excel Online and Airtable all have great nodes in n8n, Zapier and Make ([Part III](../part-3-automation/index.md)).
...
**Next:** [28 · Chat Apps & Bots →](28-chat-apps-and-bots.md)

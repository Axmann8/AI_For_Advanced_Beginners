...
([Building MCP Servers](../part-4-mcp-and-connectors/42-building-mcp-servers.md)).
...
**What it means for you:** your well-organized notes, docs and systems ([Part VIII](../part-8-knowledge-and-memory/index.md))
become a **compounding asset**. The better your context, the better your AI. And your privacy choices matter more than ever
([Privacy & Your Data](104-privacy-and-your-data.md)).
...
([Vibe Coding](../part-7-building-with-ai/65-vibe-coding-your-first-app.md)).
...
|---|---|
| 🗣️ **Clear communication** (describing outcomes) | [Context Engineering](../part-3-foundations/36-context-engineering.md) |
| 🧭 **Delegation & review** | [Claude Code Masterclass](../part-7-building-with-ai/62-claude-code-masterclass.md), [Agents](../part-7-building-with-ai/68-build-your-own-agent.md) |
| 🔌 **Systems thinking** (connecting tools) | [MCP](../part-4-mcp-and-connectors/index.md), [Automation](../part-5-automation/index.md) |
| 🔍 **Verification & evaluation** | [Evaluating AI](105-evaluating-ai.md) |
| 🛡️ **Safety & judgment** | [Safety, Costs & Gotchas](103-safety-costs-and-gotchas.md) |
| 💛 **Empathy & ethics** | [AI Ethics](107-ai-ethics-for-builders.md), [Accessibility](../part-11-ai-for-life-and-work/101-accessibility-and-ai.md) |
| 🌱 **Continuous learning** | [Staying Current](110-staying-current.md) |
...
| Loved **automation** | Build 5 automations that each save you an hour a week. Consider freelancing ([Income](109-turning-ai-skills-into-income.md)) |
| Loved **building** | Ship 3 small apps ([Build-Along: Web App](../part-13-build-alongs/115-build-along-web-app-with-ai.md)). One might become something |
| Loved **knowledge work** | Build your second brain ([Build-Along](../part-13-build-alongs/114-build-along-second-brain.md)), then write about what you learn |
| Loved **creative AI** | Make a short film, an album or a comic. Share it proudly |
| Loved **local AI** | Grow your home lab, and help others go private ([Build-Along](../part-13-build-alongs/117-build-along-private-home-assistant.md)) |
...
**Next:** [112 · Your Pocket AI Assistant on Telegram →](../part-13-build-alongs/112-build-along-pocket-ai-assistant.md)

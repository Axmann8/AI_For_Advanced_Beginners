...
Want to see the loop *without* the helper? That's exactly what [Ch. 21](37-build-your-own-agent.md) and the
...
More in [Ch. 39: Cost Optimization](../part-10-mastery/75-cost-optimization.md).
...
- **Local models** (Ollama, LM Studio) expose HTTP APIs on your machine ([Ch. 26](../part-7-local-ai/47-local-and-open-models.md)).
...
**Next:** [21 · Build Your Own Agent →](37-build-your-own-agent.md)

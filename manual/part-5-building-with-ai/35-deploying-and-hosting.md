# 35 · Deploying & Hosting: Put Your Creation on the Internet 🌍🚀
...
| **CI/CD** | Robots that test and deploy on every push ([Git & GitHub](30-git-and-github.md#-github-actions-robots-that-work-for-you)) |
...
| **Home server** | A mini PC or Raspberry Pi | Private tools, local AI ([Home Lab](../part-7-local-ai/49-home-lab.md)) |
...
> arrives. That means a serverless function can host your bot for free or nearly free ([Webhooks, APIs & JSON](../part-3-automation/15-webhooks-apis-json.md)).
...
and other people's apps ([Building MCP Servers](../part-2-mcp-and-connectors/11-building-mcp-servers.md)).
...
tool outputs ✅. The full walkthrough is [Build-Along: Publish an MCP Server](../part-11-build-alongs/82-build-along-publish-an-mcp-server.md).
...
| **AI API calls** | The biggest variable! | **Spend limits**, rate limits, caching ([Cost Optimization](../part-10-mastery/75-cost-optimization.md)) |
...
> [!TIP]
> **🎮 Try this**
> Take the tiny compliment page from [Git & GitHub](30-git-and-github.md) (or any HTML file), push it to GitHub, and turn on
> **GitHub Pages**. Then send the link to a friend. Your first thing on the internet, live in under 10 minutes. 🌍🎉

---

**Next:** [36 · Calling AI APIs Directly →](36-calling-ai-apis.md)

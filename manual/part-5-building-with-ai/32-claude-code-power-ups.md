# 32 · Claude Code Power-Ups: Skills, Subagents, Hooks, Plugins & More ⚡🧙

> ⏱️ 10 min read · 🎯 Intermediate · 🧰 Needs: Claude Code installed ([Masterclass](31-claude-code-masterclass.md) first)
...
built."* Subagents can also run **in parallel** for big jobs ([Multi-Agent Systems](39-multi-agent-systems.md)).
...
docs), a database server, Sentry, and your notes app. Full catalog in [MCP Server Catalog](../part-2-mcp-and-connectors/09-mcp-server-catalog.md).
...
- 🧩 **n8n / Zapier:** call `claude -p` from an Execute Command node on your server ([n8n Masterclass](../part-3-automation/16-n8n-masterclass.md)).
...
[Build Your Own Agent](37-build-your-own-agent.md).
...
**Next:** [33 · Cursor & AI IDEs →](33-cursor-and-ai-ides.md)

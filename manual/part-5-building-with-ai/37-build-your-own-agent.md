...
Once you understand the loop, use the SDK's **tool runner** to skip the boilerplate ([Ch. 20](36-calling-ai-apis.md)).
...
| **No-code**: n8n AI Agent, Zapier Agents, Make AI Agents | Nothing (visual) | Agents wired into business workflows ([Part III](../part-3-automation/14-automation-platforms.md)) |
...
**Next:** [22 · Multi-Agent Systems →](39-multi-agent-systems.md)

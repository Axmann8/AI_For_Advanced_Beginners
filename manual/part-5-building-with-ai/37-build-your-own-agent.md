...
agent `remember(fact)` and `recall(query)` tools backed by a file or database ([Memory for Agents](../part-6-knowledge-and-memory/44-memory-for-agents.md)).
...
Once you understand the loop, use the SDK's **tool runner** to skip the boilerplate ([Calling AI APIs](36-calling-ai-apis.md#-tool-use-letting-the-model-call-your-functions)).
...
([Claude Code Power-Ups](32-claude-code-power-ups.md#-the-claude-agent-sdk)).
...
| **Frameworks** (LangGraph, OpenAI Agents SDK, CrewAI, Pydantic AI, Mastra, Google ADK) | Framework-style code | Complex graphs, multi-provider setups, team conventions ([Agent Frameworks Tour](38-agent-frameworks-tour.md)) |
| **No-code** (n8n AI Agent, Zapier Agents, Make AI Agents) | Nothing (visual) | Agents wired into business workflows ([n8n AI Agents](../part-3-automation/17-n8n-ai-agents.md)) |
...
5. **Observe:** log trajectories, and review failures to improve prompts and tools ([Evaluating AI](../part-10-mastery/74-evaluating-ai.md)).
...
| Agent | Tools |
|---|---|
| 📚 Research agent | web search, fetch, save_note ([Build-Along](../part-11-build-alongs/85-build-along-research-agent.md)) |
...
**Next:** [38 · Agent Frameworks Tour →](38-agent-frameworks-tour.md)

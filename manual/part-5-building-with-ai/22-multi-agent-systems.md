...
| Level | How |
|---|---|
| 🟢 **Claude Code subagents** | Create `researcher` and `reviewer` subagents with `/agents`, then say *"use the researcher subagent to…"* ([Ch. 18](18-claude-code-masterclass.md)) |

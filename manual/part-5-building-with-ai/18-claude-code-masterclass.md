...
- **MCP:** `claude mcp add ...` gives Claude Code GitHub, Playwright, Sentry, databases, Notion… ([Ch. 4](../part-2-mcp-and-connectors/04-mcp-explained.md))
...
- **Claude Agent SDK:** the same harness as a Python/TypeScript library for building your own agents ([Ch. 21](21-build-your-own-agent.md)).
...
**Next:** [19 · Vibe Coding Your First Real App →](19-vibe-coding-your-first-app.md)

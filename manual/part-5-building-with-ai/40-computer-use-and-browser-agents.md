# 40 · Computer Use & Browser Agents: AI That Clicks for You 🖱️🌐
...
It's the same agent loop from [Build Your Own Agent](37-build-your-own-agent.md), where the "tools" are `click(x, y)`,
...
**prompt injection**, and it's the #1 risk for agents with access to your logged-in accounts ([MCP Security & Trust](../part-2-mcp-and-connectors/12-mcp-security-and-trust.md)).
...
3. **Schedule it:** a GitHub Action on a daily `schedule`, or n8n on your home server ([Web Scraping & Monitoring](../part-3-automation/20-web-scraping-and-monitoring.md)).
...
Keep an eye on this space in [Staying Current](../part-10-mastery/79-staying-current.md). 🚀

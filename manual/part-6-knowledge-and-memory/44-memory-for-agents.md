# 44 · Memory for Agents: Teaching AI to Remember 🧠📝
...
| ⚙️ **Workflow memory** | n8n Simple Memory, Postgres/Redis chat memory, Zep | Chatbots in automations ([n8n AI Agents](../part-3-automation/17-n8n-ai-agents.md)) |
...
> ([Context Engineering](../part-1-foundations/05-context-engineering.md)).
...
Add these two tools to your agent from [Build Your Own Agent](../part-5-building-with-ai/37-build-your-own-agent.md):
...
**Level up:** swap the word-matching in `recall` for embeddings ([Embeddings & Vector Databases](42-embeddings-and-vector-databases.md)),
...
> app, tell users what's stored and let them delete it ([Privacy & Your Data](../part-10-mastery/73-privacy-and-your-data.md)).
...
**Next:** [45 · Gemini Notebook (formerly NotebookLM) Masterclass →](45-notebooklm-masterclass.md)

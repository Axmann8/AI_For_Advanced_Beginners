# 41 · RAG, Memory & Knowledge: Make AI Know *Your* Stuff 🧠📚
...
| 3️⃣ **Gemini Notebook (NotebookLM)** | Upload lots of sources, get grounded answers with citations | 🟢 Minutes | Studying, research, "chat with this pile of PDFs" ([Masterclass](45-notebooklm-masterclass.md)) |
| 4️⃣ **Connectors / MCP** | AI searches your Drive, Notion or Slack live | 🟡 Setup once | *Living* knowledge that changes daily ([Built-in Connectors](../part-2-mcp-and-connectors/10-built-in-connectors.md)) |
| 5️⃣ **Memory** | Built-in memory, `CLAUDE.md`, memory MCP servers | 🟡 Setup once | Preferences and facts about *you* ([Memory for Agents](44-memory-for-agents.md)) |
| 6️⃣ **Build your own RAG** | Embeddings + vector database + retrieval | 🔴 A weekend | Big private collections, custom apps, full control ([Build a RAG System](43-build-a-rag-system.md)) |
...
The **context window** is how much text the model can consider at once ([How Models Really Work](../part-1-foundations/02-how-models-really-work.md)).
...
huge context. When a context is stuffed with irrelevant material, answers get worse ([Context Engineering](../part-1-foundations/05-context-engineering.md)).
...
| **Embedding** | A list of numbers that captures a chunk's *meaning*. Similar meaning = nearby numbers ([Embeddings & Vector Databases](42-embeddings-and-vector-databases.md)) |
...
> "second brain" that **both you and your AI** can use ([Personal Knowledge Management](46-personal-knowledge-management.md)).
...
**Next:** [42 · Embeddings & Vector Databases →](42-embeddings-and-vector-databases.md)

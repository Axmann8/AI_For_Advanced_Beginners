# 43 · Build a RAG System, Step by Step 🏗️📚
...
**In [RAG, Memory & Knowledge](41-rag-memory-and-knowledge.md) you learned *what* RAG is. Now you'll build one, four
...
([Embeddings & Vector Databases](42-embeddings-and-vector-databases.md#-measuring-closeness)).
...
3. **Share** the chat URL, or connect it to Slack or Telegram ([Chat Apps & Bots](../part-4-ai-in-your-apps/28-chat-apps-and-bots.md)).

More n8n detail in [n8n AI Agents](../part-3-automation/17-n8n-ai-agents.md#-rag-inside-n8n).
...
Change **one thing at a time** (chunk size, k, embedding model, reranker) and re-run. More in [Evaluating AI](../part-10-mastery/74-evaluating-ai.md).
...
- [ ] **Cost controls**: cache prompts, cheaper models for simple questions ([Cost Optimization](../part-10-mastery/75-cost-optimization.md))
...
| 4 | 🧑‍⚕️ **Personal health log** Q&A (local models only! [Local & Open Models](../part-7-local-ai/47-local-and-open-models.md)) | 2 (local) |
...
**Next:** [44 · Memory for Agents →](44-memory-for-agents.md)

...
In [Ch. 23](41-rag-memory-and-knowledge.md) you learned *what* RAG is. Now you'll **build one**, first from
...
Change one thing at a time (chunk size, k, embedding model) and re-run. More in [Ch. 38](../part-10-mastery/74-evaluating-ai.md).
...
4. 🧑‍⚕️ **Personal health log** Q&A (local models only! [Ch. 26](../part-7-local-ai/47-local-and-open-models.md))
...
**Next:** [25 · Personal Knowledge Management with AI →](46-personal-knowledge-management.md)

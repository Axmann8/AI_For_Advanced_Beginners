...
|---|---|---|
| **Obsidian** ([Ch. 16](../part-4-ai-in-your-apps/25-obsidian-and-ai.md)) | Ownership, privacy, tinkerers | Plugins, MCP filesystem, Claude Code, local models |
| **Notion** ([Ch. 14](../part-4-ai-in-your-apps/23-notion-ai-deep-dive.md)) | Databases, teams, polish | Notion AI + agents, official MCP |
...
| Source | Pipeline |
|---|---|
| 🎙️ Voice ideas | iOS Shortcut/Action Button → webhook → AI cleanup → Inbox ([Ch. 12](../part-3-automation/15-webhooks-apis-json.md)) |
...
Once AI can read your knowledge base (MCP, NotebookLM, Notion AI, [RAG](43-build-a-rag-system.md)):
...
**Next:** [26 · Local & Open Models →](../part-7-local-ai/47-local-and-open-models.md)

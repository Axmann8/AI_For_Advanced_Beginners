# 42 · Embeddings & Vector Databases: Search by Meaning 🧬🗺️
...
systems use **hybrid search** (keywords + embeddings) ([Build a RAG System](43-build-a-rag-system.md)).
...
- **Check the MTEB leaderboard** (Hugging Face) for rankings by task and language, then **test on your own data**. A 20-question
  eval beats any leaderboard ([Evaluating AI](../part-10-mastery/74-evaluating-ai.md)).
...
| 7 | 🔗 **Auto-linking notes** | Suggest related notes in Obsidian ([Personal Knowledge Management](46-personal-knowledge-management.md)) |
...
**Next:** [43 · Build a RAG System, Step by Step →](43-build-a-rag-system.md)
